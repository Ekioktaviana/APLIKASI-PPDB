                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <form method="post" action="{{route('document.update', $id->id)}}" enctype = "multipart/form-data">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <img src="http://localhost:8000/image/{{$id->kk}}" width="80" height="80">
                                ...
                                <div class="card mt-2">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <img src="http://localhost:8000/image/{{$id->akte}}" width="80" height="80">
                                ...
                                <div class="card mt-2">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <img src="http://localhost:8000/image/{{$id->skhun}}" width="80" height="80">
                                ...
                                <div class="card mt-2">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <img src="http://localhost:8000/image/{{$id->ijazah}}" width="80" height="80">
